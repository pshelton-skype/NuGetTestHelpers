    ...
    public class NuGetBuildVerificationTests
    {
        ...
        public void TestPackageInstall()
        {
            using (NuGetPackageTestHelper nugetHelper = new NuGetPackageTestHelper())
            {
                ...
                nugetHelper.vsProjectManager.LaunchDefaultVsSku();

                // Create project with desired template and framework.
                nugetHelper.vsProjectManager.CreateProject(ProjectTemplates.ConsoleAppCSharp, "CSharp", ProjectTargetFrameworks.Net45, projName, solnPath);
        ...
        public void TestIndividualPackageVerifiers()
        {
            using (NuGetPackageTestHelper nugetHelper = new NuGetPackageTestHelper())
            {
                ...
                //Create project with desired template and framework.
                nugetHelper.vsProjectManager.CreateProject(ProjectTemplates.ConsoleAppCSharp, "CSharp", ProjectTargetFrameworks.Net45, DateTime.Now.Ticks.ToString());
